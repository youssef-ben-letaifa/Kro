...
run_check "Simulink Canvas OK" "from kronos.ui.center.simulink.canvas import SimulinkCanvas; print('Simulink Canvas OK')"
run_check "Simulink Simulator OK" "from kronos.ui.center.simulink.simulator import DiagramSimulator; print('Simulink Simulator OK')"
run_check "Block Param Dialog OK" "from kronos.ui.center.simulink.block_param_dialog import BlockParamDialog; print('Block Param Dialog OK')"
